...
- (void)startRequest
{
   ...
   // Start the HTTP connection
	...
	[self setStatusTimer:[NSTimer timerWithTimeInterval:0.2 target:self selector:@selector(updateStatus:) userInfo:nil repeats:YES]];
